...
elemTop[i] =Math.round(parseInt($(this).offset().top-headerHHHH-headerHHHH-headerHHHH-headerHHHH-headerHHHH-headerHHHH-headerHHHH));//追従するheader分の高さ（70px）を引き小数点を四捨五入 「-headerHを消去した」
});
}
